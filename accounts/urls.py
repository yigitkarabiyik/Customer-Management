...
urlpatterns = [
    ...
    path('customer/<str:pk_test>/', views.customer, name='customer'),    # pk for customer
    
    path('create_order/<str:pk>', views.createOrder, name='create_order'),  # pk for customer
    path('update_order/<str:pk>/', views.updateOrder, name='update_order'), # pk for order
    path('delete_order/<str:pk>/', views.deleteOrder, name='delete_order'), # pk for order
